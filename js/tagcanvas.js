...
// I think all browsers pass this test now...
	...
	Tproto.Measure = function (c, t) {
		...
		c.font = this.font = 'normal'+ this.textHeight + 'px ' + this.textFont
	...
	TagCanvas.Start = function (id, l, o) {
		...
		console.log(new TagCanvas(id, l, o))
	}
	...
	TagCanvas.options = {
		...
		textColour: '#ff99ff',
		textHeight: 15,
		textFont: 'JDLangZhengTi, PingFang SC, Microsoft Yahei,SimHei,Helvetica, Arial, sans-serif',
		shadow: '#000',
		shadowBlur: 0,
		shadowOffset: [0, 0],
		initial: null,
