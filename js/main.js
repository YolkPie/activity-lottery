...
document.onkeydown = function(e){
	...
	if($main.className.indexOf('cover') > -1){
		let $btnClose = document.getElementById('result').getElementsByClassName('close')[0]
		$btnClose.click()
		return
	}
	...
	if($resultPanel.style.display === 'block'){
		...
		$main.className = $main.className.replace('cover', '')
		TagCanvas.SetSpeed('myCanvas', speed())
		return
	}
...
function showDialog(dgId){
	let $dialog = document.getElementById(dgId)
	let $main = document.getElementById('main')
	$dialog.style.display = 'block'
	$main.className += ' cover'
}

function hideDialog(dgId){
	let $dialog = document.getElementById(dgId)
	let $main = document.getElementById('main')
